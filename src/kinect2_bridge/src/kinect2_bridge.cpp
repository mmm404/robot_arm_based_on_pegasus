...
private:
  bool initialize()
  {
    ...
    // Change the default to CPU instead of OpenGL
    std::string depthDefault = "cpu";
    std::string regDefault = "default";  // Also change registration to CPU

// Remove or comment out these lines that override the CPU default
...
// #endif
    ...
    // Start device immediately after initialization
    OUT_INFO(this, "Starting device streams...");
