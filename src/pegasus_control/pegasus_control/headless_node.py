...
from pegasus_control.pegasus_commander import PegasusCommander
...
class HeadlessCommander(Node):
    ...
    def joint_command_callback(self, msg):
        ...
        try:
            ...
            if result['success']:
                self.commander.execute_live_trajectory(result['trajectory'])
            else:
    ...
    def pose_command_callback(self, msg):
        ...
        self.get_logger().info(f"Received pose command")
        try:
            # Extract pose
